...
public class QrcodeUtil {
    ...
    public static boolean encodeQRCodeImage(String content, String charset, String imagePath, int width, int height, String logoPath) {
        ...
        try {
            ...
            log.error("when encoding QRImage occur an exception",e);
            return false;
        }
        ...
        try {
            ...
            log.info("生成二维码图片[" + imagePath + "]时遇到异常,堆栈轨迹如下");
            e.printStackTrace();
            return false;
        }
        ...
        if(null == logoPath){
            ...
            try {
                ...
                log.error("QRImage in path:[" + imagePath + "]when adding logo image of path:[" + logoPath + "] occured a exception:",e);
                return false;
            }
        }
    }
    ...
    public static String decodeQRCodeImage(String imagePath, String charset) {
        ...
        try {
            ...
            log.error("QRImage was not find:",e);
            return "";
        }
        if(null == image){
        ...
        try {
            ...
            log.error("QRImage in path:[" + imagePath + "]decode error ,exception was",e);
            return "";
        }
    }
