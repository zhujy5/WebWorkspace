...
public class EncryptUtil {  
    ...
    public static String key = "LmMGStGtOpFHIobsnhHIDUD7d985e87b8ndOH87WD4xNyvYt54EQ==";  
    ...
    public static void main(String[] args) throws Exception {
    	String beforeStr = "1232H$^&^%7*_)(Pbv)Iin%&*(0vCy826";
    	System.out.println("加密前：" + beforeStr);
        System.out.println("密钥：" + key);
        String secretStr = encrypt(beforeStr);
        System.out.println("加密后：" + secretStr);
        String decryptStr = decrypt(secretStr);
